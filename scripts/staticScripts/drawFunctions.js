...
class DrawFunctions {
     ...
     */
    static drawLine(steps, startLocation, endLocation, particleName = "minecraft:blue_flame_particle", molangVars) {
    ...
    static drawCube(a, b, particleName = "minecraft:blue_flame_particle", resolution = 2, molangVars) {
        let boxStart = {
            x: a.x < b.x ? a.x : b.x,
            y: a.y < b.y ? a.y : b.y,
            z: a.z < b.z ? a.z : b.z,
        ...
        DrawFunctions.drawLine(resolution, { x: boxStart.x, y: boxStart.y, z: boxStart.z }, { x: boxEnd.x, y: boxStart.y, z: boxStart.z }, particleName, molangVars);
        DrawFunctions.drawLine(resolution, { x: boxStart.x, y: boxStart.y, z: boxStart.z }, { x: boxStart.x, y: boxEnd.y, z: boxStart.z }, particleName, molangVars);
        DrawFunctions.drawLine(resolution, { x: boxStart.x, y: boxStart.y, z: boxStart.z }, { x: boxStart.x, y: boxStart.y, z: boxEnd.z }, particleName, molangVars);
        DrawFunctions.drawLine(resolution, { x: boxEnd.x, y: boxEnd.y, z: boxEnd.z }, { x: boxStart.x, y: boxEnd.y, z: boxEnd.z }, particleName, molangVars);
        DrawFunctions.drawLine(resolution, { x: boxEnd.x, y: boxEnd.y, z: boxEnd.z }, { x: boxEnd.x, y: boxStart.y, z: boxEnd.z }, particleName, molangVars);
        DrawFunctions.drawLine(resolution, { x: boxEnd.x, y: boxEnd.y, z: boxEnd.z }, { x: boxEnd.x, y: boxEnd.y, z: boxStart.z }, particleName, molangVars);
        DrawFunctions.drawLine(resolution, { x: boxEnd.x, y: boxStart.y, z: boxStart.z }, { x: boxEnd.x, y: boxStart.y, z: boxEnd.z }, particleName, molangVars);
        DrawFunctions.drawLine(resolution, { x: boxEnd.x, y: boxStart.y, z: boxStart.z }, { x: boxEnd.x, y: boxEnd.y, z: boxStart.z }, particleName, molangVars);
        DrawFunctions.drawLine(resolution, { x: boxStart.x, y: boxStart.y, z: boxEnd.z }, { x: boxEnd.x, y: boxStart.y, z: boxEnd.z }, particleName, molangVars);
        DrawFunctions.drawLine(resolution, { x: boxStart.x, y: boxStart.y, z: boxEnd.z }, { x: boxStart.x, y: boxEnd.y, z: boxEnd.z }, particleName, molangVars);
        DrawFunctions.drawLine(resolution, { x: boxStart.x, y: boxEnd.y, z: boxStart.z }, { x: boxEnd.x, y: boxEnd.y, z: boxStart.z }, particleName, molangVars);
        DrawFunctions.drawLine(resolution, { x: boxStart.x, y: boxEnd.y, z: boxStart.z }, { x: boxStart.x, y: boxEnd.y, z: boxEnd.z }, particleName, molangVars);
    }
    /**
     *
     * @param {number} steps
    ...
    static async drawGraph(steps, startLocation, endLocation, player) {
        return new Promise(async (resolve) => {
            endLocation = VectorFunctions.addVector(endLocation, {
                x: 0,
                y: 1,
                z: 0,
            });
            ...
            do {
                 ...
                 * @type {import("@minecraft/server").Vector3}
                 */
                let particleLocation = VectorFunctions.addVector(startLocation, {
                    x: xOffset,
                    y: 0,
                    z: 0,
                });
