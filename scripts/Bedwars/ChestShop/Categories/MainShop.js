...
items[0] = addPriceToItem((any) => stoneSword, (any) => {
    return {
        priceAmount: 10,
...
items[2] = addPriceToItem(getColoredWool, () => {
    return {
        priceAmount: 4,
        priceTypeId: "minecraft:copper_ingot",
    };
}, buyItem);
items[3] = addPriceToItem(getColoredGlass, () => {
    return {
        priceAmount: 12,
        priceTypeId: "minecraft:copper_ingot",
    };
}, buyItem);
items[4] = addPriceToItem(() => getArmor(1), () => getArmorPrice(1), (_shop, player, _missingItem, _price) => buyArmor(1, _shop, player, _missingItem, _price));
...
items[5] = addPriceToItem((any) => ironGOlem, (any) => {
    return {
        priceAmount: 64,
        priceTypeId: "minecraft:copper_ingot",
    };
...
items[6] = addPriceToItem((any) => windCharger, (any) => {
    return {
        priceAmount: 40,
        priceTypeId: "minecraft:copper_ingot",
    };
...
items[7] = addPriceToItem((any) => waterBucket, (any) => {
    return {
        priceAmount: 2,
...
items[9] = addPriceToItem((any) => ironSword, (any) => {
    return {
        priceAmount: 7,
        priceTypeId: "minecraft:iron_ingot",
    };
...
items[11] = addPriceToItem(getColoredTerracotta, () => {
    return {
        priceAmount: 12,
        priceTypeId: "minecraft:copper_ingot",
    };
...
items[12] = addPriceToItem((any) => planks, (any) => {
    return {
        priceAmount: 4,
        priceTypeId: "minecraft:iron_ingot",
    };
}, buyItem);
items[13] = addPriceToItem(() => getArmor(2), () => getArmorPrice(2), (_shop, player, _missingItem, _price) => buyArmor(2, _shop, player, _missingItem, _price));
...
items[14] = addPriceToItem((any) => snowGolem, (any) => {
    return {
        priceAmount: 15,
        priceTypeId: "minecraft:copper_ingot",
    };
...
items[15] = addPriceToItem((any) => enderPearl, (any) => {
    return {
        priceAmount: 4,
...
items[16] = addPriceToItem((any) => milkBucket, (any) => {
    return {
        priceAmount: 4,
        priceTypeId: "minecraft:iron_ingot",
    };
...
items[17] = addPriceToItem((any) => tnt, (any) => {
    return {
        priceAmount: 4,
        priceTypeId: "minecraft:iron_ingot",
    };
...
items[18] = addPriceToItem((any) => diamondSword, (any) => {
    return {
        priceAmount: 4,
        priceTypeId: "minecraft:diamond",
    };
...
items[20] = addPriceToItem((any) => deepslate, (any) => {
    return {
        priceAmount: 24,
        priceTypeId: "minecraft:copper_ingot",
    };
...
items[21] = addPriceToItem((any) => obsidian, (any) => {
    return {
        priceAmount: 4,
        priceTypeId: "minecraft:diamond",
    };
}, buyItem);
items[22] = addPriceToItem(() => getArmor(3), () => getArmorPrice(3), (_shop, player, _missingItem, _price) => buyArmor(3, _shop, player, _missingItem, _price));
const sponge = new ItemStack("minecraft:sponge");
sponge.nameTag = "§r§fSponge";
sponge.amount = 4;
sponge.setLore(sponge.getLore().concat(["§r§l§f2x Iron"]));
items[23] = addPriceToItem((any) => sponge, (any) => {
    return {
        priceAmount: 2,
        priceTypeId: "minecraft:iron_ingot",
    };
...
items[24] = addPriceToItem((any) => enemyTracker, (any) => {
    return {
        priceAmount: 3,
        priceTypeId: "minecraft:diamond",
    };
...
items[26] = addPriceToItem((any) => ladder, (any) => {
    return {
        priceAmount: 4,
        priceTypeId: "minecraft:copper_ingot",
    };
