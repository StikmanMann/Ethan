...
export const getShears = (player) => {
    return shears;
};
export const buyShears = (shopEntity, buyer, missingItem, price) => {
...
addCommand({
    ...
    chatFunction: (chatSendEvent) => {
        ...
        if (isNaN(level)) {
            chatSendEvent.sender.sendMessage("Please enter a number 0 false / 1 true");
        }
