...
export const axeLevels: ItemStack[] = [
  null,
  levelOne,
  levelTwo,
  levelThree,
...
export const getAxe = (player: Player): ItemStack => {
...
export const getAxePrice = (player: Player): Price => {
  const level = player.getAxeLevel();
